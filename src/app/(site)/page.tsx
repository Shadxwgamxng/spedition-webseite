      ...
      <section className="relative overflow-hidden bg-navy-950 text-white">
        ...
        <Container className="relative py-24 sm:py-32">
          ...
          <dl className="mt-16 grid grid-cols-2 gap-6 border-t border-white/10 pt-10 sm:grid-cols-4">
            {stats.map((stat) => (
              <div key={stat.label}>
                <dt className="text-2xl font-bold text-amber-400 sm:text-3xl">{stat.value}</dt>
            ...
            {services.map((service) => {
              ...
              return (
                <Card key={service.slug} className="flex flex-col">
                  ...
                  >
                    Mehr erfahren <ArrowRightIcon className="h-4 w-4" />
                  </Link>
                </Card>
              );
            })}
          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
            <div>
              ...
              <ul className="mt-6 space-y-3 text-sm text-white/80">
                {[
                  ...
                  "Lagerverwaltung mit digitalen Inventuren",
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div
                  key={item.label}
                  className="flex flex-col items-start gap-3 rounded-2xl border border-white/10 bg-white/5 p-5"
                >
          ...
          <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {fleet.map((item) => (
              <Card key={item.category}>
                <div className="text-3xl font-bold text-navy-900">{item.count}</div>
            ...
            <div className="space-y-3">
              {jobs.slice(0, 3).map((job) => (
                <Link
                  ...
                  className="flex items-center justify-between rounded-xl border border-white/10 bg-white/5 p-4 text-sm hover:bg-white/10"
                >
                  <span>
                  ...
                  <ArrowRightIcon className="h-4 w-4 shrink-0 text-amber-400" />
                </Link>
              ))}
            </div>
          </div>
        ...
        <Container>
          ...
          <div className="mt-10 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6">
            {partners.map((partner) => (
              <div
                key={partner.name}
                className="flex flex-col items-center justify-center rounded-xl border border-navy-900/8 bg-white px-3 py-6 text-center"
              >
